...
export default function Kiosk({ db, token, onExit }) {
  ...
  const fetchSOA = async (property) => {
    ...
    try {
      ...
      setMultiProps(null);
    } catch (e) {console.error(e); setError("System error while loading SOA."); }
    setLoading(false);
  };
  ...
  const handleSearch = async () => {
    ...
    } catch (e) {console.error(e); setError("System error. Please check database permissions or internet connection."); }
    setLoading(false);
  };

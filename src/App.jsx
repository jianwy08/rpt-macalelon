...
function Sidebar({ active, setActive, profile, onLogout, delinqCount }) {
  const sections = [
    ...
    // 🌟 1. ADDED SETTINGS TO YOUR MENU ARRAY
    { label:"System", items:[
  ...
  return (
    <div className="sidebar">
      ...
      <div className="sb-footer">
        {/* 🌟 2. ADDED THE CONFIRMATION PROMPT TO YOUR EXISTING LOGOUT FOOTER */}
        <div className="sb-user" onClick={() => { if(window.confirm("Are you sure you want to sign out?")) onLogout(); }} title="Sign out">
